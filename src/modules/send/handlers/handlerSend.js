...
class SendTransaction {
  ...
  async submitTransaction() {
    try {
      // Track transaction preparation
      await ParallaxService.trackTransaction({
        event: 'prepare_tx',
        from: this.TX.from,
        to: this.TX.to,
        value: this.TX.value,
      ...
      await ParallaxService.addSpanEvent('set_tx_fields', {
        to: this.TX.to,
        value: this.TX.value,
      ...
      await ParallaxService.addSpanEvent('nonce_retrieved', {
        nonce
      });
      ...
      await ParallaxService.addSpanEvent('transaction_ready', {
        from: json.from,
        to: json.to,
        value: json.value
      });
      ...
      await ParallaxService.addSpanEvent('transaction_error', {
